        ...
        <nav class="navbar navbar-expand-lg bg-body-secondary" style="position: fixed;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/') }}">Tentang Program</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/') }}">Berita</a>
                    </li>
                    <button type="button" class="nav-button"
                        onclick="window.location.href='registration';">Registrasi</button>
                </ul>
            </div>
        </nav>
        <section>
            <div class="registration">
                <div class="registration-background">
                    ...
                    <div class="registration-form">
                        ...
                        <input type="number" id="nomorTelepon" class="form-input" placeholder="Nomor Telepon*"
                            required>
